...
?>
											...
											<a href="reg-users.php" class="block-anchor panel-footer text-center">FULL DETAILS <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
<div class="stat-panel-title text-uppercase">Listed Bicycles</div>
</div>
</div>
<a href="manage-vehicles.php" class="block-anchor panel-footer text-center">FULL DETAILS &nbsp; <i class="fa fa-arrow-right"></i></a>
</div>
</div>
<div class="col-md-3">
<div class="panel panel-default">
...
?>
											...
											<a href="manage-bookings.php" class="block-anchor panel-footer text-center">FULL DETAILS &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>												
											...
											<a href="manage-brands.php" class="block-anchor panel-footer text-center">FULL DETAILS &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
...
?>
											...
											<a href="manage-subscribers.php" class="block-anchor panel-footer text-center">FULL DETAILS <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
